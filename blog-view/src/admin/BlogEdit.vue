  ...
  <div>
    ...
    <div class="m-content">
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" class="demo-ruleForm" label-position="top"
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="分类" prop="cate">
              <el-select v-model="ruleForm.typeId" :allow-create="true" :filterable="true" placeholder="请选择分类" style="width: 100%;">
          ...
          <el-col :span="12">
            <el-form-item label="标签" prop="tagList">
              <el-select v-model="ruleForm.tagList" :allow-create="true" :filterable="true" :multiple="true" placeholder="请选择标签" style="width: 100%;">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="浏览次数" prop="views">
              <el-input v-model="ruleForm.views" placeholder="请输入浏览字数（可选）默认为 0" type="number"></el-input>
            </el-form-item>
          </el-col>
          <!--是否公开-->
          <el-col :span="12">
        ...
        <!--提交和重置按钮-->
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm')" v-if="ruleForm.id == ''">立即创建</el-button>
          <el-button type="primary" @click="submitForm('ruleForm')" v-if="ruleForm.id != ''">更新</el-button>
...
export default {
  ...
  methods: {
    ...
    getTagsList() {
      const _this = this
      this.$axios.get('/tags/all').then(res => {
