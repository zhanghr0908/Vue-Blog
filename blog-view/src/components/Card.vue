  ...
  <div class="card">
    ...
    <div class="card-middle">
      <div style="max-width: 40px;margin-left: 40px">
        <el-image :fit="fit"
                  src="http://r9vd4j8w3.hd-bkt.clouddn.com/img/githubLogo.jpg"
    ...
    <div class="card-footer">
      <el-collapse>
        <el-collapse-item name="2" style="padding-left: 20px;padding-right: 20px" title="个人简介">
          <div>是一个不折不扣的码农，程序猿。</div>
        </el-collapse-item>
...
export default {
  ...
  data() {
    return {
      ...
      fit: 'fill',
      user: {
        avatar: "http://r9vd4j8w3.hd-bkt.clouddn.com/img/avatar.jpg"
      },
    }
  },
  methods: {
